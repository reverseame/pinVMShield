/*
 * @filename 		DebuggerDetectionAPIWrapper.h
...
class DebuggerDetectionAPIWrapper: public DetectionAPIWrapper
{
	public:
		DebuggerDetectionAPIWrapper():DetectionAPIWrapper()
		{
		}

		~DebuggerDetectionAPIWrapper(){};
